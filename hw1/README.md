...
## Git Repository Links (25 pts)

Add this section to your submission with working links to your repository files.
These links point to the start of the exact code instances requested for HW1.

- [ ] **API query script**  
  `https://github.com/mohdLabadi/sysen/blob/main/04_deployment/hw1/api_client.py#L35`
- [ ] **Shiny app code**  
  `https://github.com/mohdLabadi/sysen/blob/main/04_deployment/hw1/app.py#L20`
- [ ] **AI reporting script**  
  `https://github.com/mohdLabadi/sysen/blob/main/04_deployment/hw1/ai_reporter.py#L117`
- [ ] **Main application file (if different)**  
  `https://github.com/mohdLabadi/sysen/blob/main/04_deployment/hw1/app.py#L83`

Before submitting, click each link to confirm it opens the correct file.
